...
//         setBgSpy = spyOn<any>(service['drawingService'], 'setBackground');
//     });
...
//     // it('should an element to undo stack', () => {
//     //     const clearSpy = spyOn<any>(service['redoStack'], 'clear').and.callThrough();
...
//         expect(setBgSpy).toHaveBeenCalled();
//     });
...
//     it('onKeyDwn should call undo if ctrl+z is pressed', () => {
//         const keyEvent = { ctrlKey: true, shiftKey: true, code: 'KeyZ' } as KeyboardEvent;
...
//     it('onKeyDwn should call undo if ctrl+z is pressed', () => {
//         const keyEvent = { ctrlKey: true, shiftKey: false, code: 'KeyZ' } as KeyboardEvent;
...
//     fit('undo should not draw the image if there no image loaded from gallery', () => {
